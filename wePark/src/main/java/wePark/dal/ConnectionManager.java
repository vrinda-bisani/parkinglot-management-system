...
public class ConnectionManager {
	...
	private final String user = "dbmasteruser";
	// Password for the user.
	private final String password = "wePark123";
	// URI to your database server. If running on the same machine, then this is "localhost".
	private final String hostName = "ls-9d89604a7ef4cae2a950f926d03b9f335cc1c0c0.c0dnrskdpcf9.us-west-2.rds.amazonaws.com";
	// Port to your database server. By default, this is 3307.
	private final int port= 3306;
	// Name of the MySQL schema that contains your tables.
	private final String schema = "wePark";
